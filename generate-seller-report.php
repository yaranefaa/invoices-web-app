...
<body>
  ...
  <center>
    <form method="post" id="seller_report_form" action="print-seller-report.php">
      <input type="text" style="width:30%;margin-top:20px" name="sellerName" id="sellerName" class="form-control input-sm" placeholder="Enter Seller ID" autocomplete="off" required />
      ...
      <input type="submit" style="margin-top:20px" name="generate_seller_report" id="generate_seller_report" class="btn btn-info" value="Generate Report" />
    </form>
  </center>
